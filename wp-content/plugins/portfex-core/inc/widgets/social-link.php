...
class Portfex_footer_social_Widget extends WP_Widget {
 
    function __construct() {
 
        parent::__construct(
            'portfex-footer-socail',  // Base ID
            'Portfex: Footer Social'   // Name
        );
 
        add_action( 'widgets_init', function() {
            register_widget( 'Portfex_footer_social_Widget' );
        });
...
$portfex_footer_social = new Portfex_footer_social_Widget();
